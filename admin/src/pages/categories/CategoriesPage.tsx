...
export default function CategoriesPage() {
  ...
  const flatRows = useMemo(() => flattenWithDepth(categories || []), [categories]);
  const parentOptions = useMemo(() => buildParentOptions(categories || [], editing?.id), [categories, editing]);
                ...
                <tr key={c.id} style={{ borderBottom: '1px solid var(--gray-100)' }}>
                  ...
                  <td style={td}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 4, paddingLeft: depth * 24 }}>
                      ...
                      {depth === 0 && (categories || []).some((x) => x.parentId === c.id) && (
